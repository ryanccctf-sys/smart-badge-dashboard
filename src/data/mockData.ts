...
export const CITY_NODES: CityNode[] = [
  { id: 'shanghai', name: '上海', provinceName: '上海市', stores: 82, activeUsers: 648, todaySessions: 2860, x: 825, y: 495, lat: 31.2304, lng: 121.4737, isHotspot: true },
  { id: 'beijing', name: '北京', provinceName: '北京市', stores: 78, activeUsers: 590, todaySessions: 2540, x: 720, y: 310, lat: 39.9042, lng: 116.4074, isHotspot: true },
  { id: 'guangzhou', name: '广州', provinceName: '广东省', stores: 56, activeUsers: 430, todaySessions: 1860, x: 715, y: 645, lat: 23.1291, lng: 113.2644, isHotspot: true },
  { id: 'shenzhen', name: '深圳', provinceName: '广东省', stores: 62, activeUsers: 510, todaySessions: 2120, x: 728, y: 658, lat: 22.5431, lng: 114.0579, isHotspot: true },
  { id: 'hangzhou', name: '杭州', provinceName: '浙江省', stores: 51, activeUsers: 410, todaySessions: 1780, x: 810, y: 520, lat: 30.2741, lng: 120.1551, isHotspot: true },
  { id: 'chengdu', name: '成都', provinceName: '四川省', stores: 43, activeUsers: 350, todaySessions: 1520, x: 525, y: 505, lat: 30.5728, lng: 104.0668, isHotspot: true },
  { id: 'wuhan', name: '武汉', provinceName: '湖北省', stores: 39, activeUsers: 310, todaySessions: 1340, x: 690, y: 490, lat: 30.5928, lng: 114.3055 },
  { id: 'chongqing', name: '重庆', provinceName: '重庆市', stores: 37, activeUsers: 290, todaySessions: 1280, x: 565, y: 535, lat: 29.5630, lng: 106.5516, isHotspot: true },
  { id: 'xian', name: '西安', provinceName: '陕西省', stores: 32, activeUsers: 250, todaySessions: 1090, x: 590, y: 420, lat: 34.3416, lng: 108.9398 },
  { id: 'zhengzhou', name: '郑州', provinceName: '河南省', stores: 31, activeUsers: 240, todaySessions: 1020, x: 680, y: 415, lat: 34.7466, lng: 113.6253 },
  { id: 'changsha', name: '长沙', provinceName: '湖南省', stores: 28, activeUsers: 220, todaySessions: 940, x: 680, y: 560, lat: 28.2282, lng: 112.9388 },
  { id: 'jinan', name: '济南', provinceName: '山东省', stores: 26, activeUsers: 200, todaySessions: 880, x: 730, y: 370, lat: 36.6512, lng: 117.1201 },
  { id: 'qingdao', name: '青岛', provinceName: '山东省', stores: 25, activeUsers: 190, todaySessions: 830, x: 780, y: 365, lat: 36.0671, lng: 120.3826 },
  { id: 'suzhou', name: '苏州', provinceName: '江苏省', stores: 44, activeUsers: 360, todaySessions: 1610, x: 818, y: 488, lat: 31.2989, lng: 120.5853 },
  { id: 'nanjing', name: '南京', provinceName: '江苏省', stores: 36, activeUsers: 280, todaySessions: 1220, x: 780, y: 470, lat: 32.0603, lng: 118.7969 },
  { id: 'tianjin', name: '天津', provinceName: '天津市', stores: 29, activeUsers: 210, todaySessions: 920, x: 740, y: 320, lat: 39.0842, lng: 117.2009 },
  { id: 'fuzhou', name: '福州', provinceName: '福建省', stores: 27, activeUsers: 195, todaySessions: 860, x: 780, y: 580, lat: 26.0745, lng: 119.2965 },
  { id: 'nanchang', name: '南昌', provinceName: '江西省', stores: 24, activeUsers: 180, todaySessions: 780, x: 720, y: 540, lat: 28.6829, lng: 115.8582 },
  { id: 'hefei', name: '合肥', provinceName: '安徽省', stores: 28, activeUsers: 210, todaySessions: 910, x: 740, y: 480, lat: 31.8612, lng: 117.2830 },
  { id: 'taiyuan', name: '太原', provinceName: '山西省', stores: 21, activeUsers: 160, todaySessions: 690, x: 670, y: 360, lat: 37.8706, lng: 112.5489 },
  { id: 'shijiazhuang', name: '石家庄', provinceName: '河北省', stores: 23, activeUsers: 175, todaySessions: 740, x: 710, y: 350, lat: 38.0428, lng: 114.5149 },
  { id: 'shenyang', name: '沈阳', provinceName: '辽宁省', stores: 25, activeUsers: 190, todaySessions: 820, x: 810, y: 280, lat: 41.8057, lng: 123.4315 },
  { id: 'changchun', name: '长春', provinceName: '吉林省', stores: 22, activeUsers: 165, todaySessions: 710, x: 850, y: 240, lat: 43.8171, lng: 125.3235 },
  { id: 'harbin', name: '哈尔滨', provinceName: '黑龙江省', stores: 24, activeUsers: 180, todaySessions: 790, x: 870, y: 190, lat: 45.8038, lng: 126.5350 },
  { id: 'kunming', name: '昆明', provinceName: '云南省', stores: 26, activeUsers: 195, todaySessions: 840, x: 520, y: 620, lat: 25.0406, lng: 102.7123 },
  { id: 'guiyang', name: '贵阳', provinceName: '贵州省', stores: 21, activeUsers: 155, todaySessions: 670, x: 570, y: 590, lat: 26.6470, lng: 106.6302 },
  { id: 'nanning', name: '南宁', provinceName: '广西壮族自治区', stores: 23, activeUsers: 170, todaySessions: 730, x: 600, y: 650, lat: 22.8170, lng: 108.3665 },
  { id: 'haikou', name: '海口', provinceName: '海南省', stores: 18, activeUsers: 130, todaySessions: 560, x: 630, y: 730, lat: 20.0440, lng: 110.1999 },
  { id: 'urumqi', name: '乌鲁木齐', provinceName: '新疆维吾尔自治区', stores: 19, activeUsers: 140, todaySessions: 610, x: 230, y: 210, lat: 43.8256, lng: 87.6271 },
  { id: 'lanzhou', name: '兰州', provinceName: '甘肃省', stores: 18, activeUsers: 135, todaySessions: 580, x: 510, y: 390, lat: 36.0611, lng: 103.8343 },
  { id: 'yinchuan', name: '银川', provinceName: '宁夏回族自治区', stores: 15, activeUsers: 110, todaySessions: 470, x: 550, y: 360, lat: 38.4872, lng: 106.2309 },
  { id: 'xining', name: '西宁', provinceName: '青海省', stores: 14, activeUsers: 100, todaySessions: 430, x: 460, y: 390, lat: 36.6232, lng: 101.7782 },
  { id: 'lhasa', name: '拉萨', provinceName: '西藏自治区', stores: 12, activeUsers: 85, todaySessions: 360, x: 290, y: 480, lat: 29.6525, lng: 91.1721 },
  { id: 'taipei', name: '台北', provinceName: '台湾省', stores: 16, activeUsers: 120, todaySessions: 520, x: 830, y: 610, lat: 25.0330, lng: 121.5654 },
  { id: 'hongkong', name: '香港', provinceName: '香港特别行政区', stores: 15, activeUsers: 115, todaySessions: 490, x: 730, y: 665, lat: 22.3193, lng: 114.1694 },
];
